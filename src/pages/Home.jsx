...
const weekEnd = addDays(weekStart, 4)
  ...
  return (
    <div>
      <h2 style={{ marginBottom: '8px', color: '#1f2937', fontSize: '22px' }}>
        本週請假總覽
      </h2>
      <p style={{ color: '#6b7280', marginBottom: '24px', fontSize: '14px' }}>
        {format(weekStart, 'yyyy/MM/dd', { locale: zhTW })} ～ {format(weekEnd, 'yyyy/MM/dd', { locale: zhTW })}
      </p>
          ...
          {weekLeaves.map(leave => (
            <div key={leave.id} style={{
              ...
              <div style={{
                ...
                height: '40px',
                borderRadius: '50%',
                backgroundColor: leave.leave_type?.color + '20' || '#EEF2FF',
                display: 'flex',
                alignItems: 'center',
              ...
              <div style={{
                backgroundColor: leave.leave_type?.color + '15' || '#EEF2FF',
                color: leave.leave_type?.color || '#4F46E5',
                padding: '4px 12px',
                borderRadius: '20px',
                fontSize: '12px',
